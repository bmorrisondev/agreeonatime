...
const SUPPORT_EMAIL = 'support@agreeonatime.com';
...
export default function SettingsScreen(): ReactElement {
  ...
  return (
    ...
    >
      ...
      <View className="px-ds-lg">
        <DsListItem
          title={t('settings_support_email')}
          subtitle={t('settings_support_email_subtitle')}
          rightAccessory={chevron}
          accessibilityLabel={t('settings_support_email')}
