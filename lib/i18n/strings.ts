...
export const strings = {
  ...
  settings_test_reminder_sent_title: 'Test email queued',
  settings_test_reminder_sent_body: 'Check {{email}} for a reminder about “{{event}}”.',
  settings_test_reminder_error_title: 'Could not send test email',
  settings_test_reminder_error_body: 'Check Convex dev env: RESEND_API_KEY and DEV_REMINDER_TEST_ENABLED.',
  settings_test_reminder_sign_in_title: 'Sign in required',
  settings_test_reminder_sign_in_body: 'Sign in to send a test reminder to your email.',
